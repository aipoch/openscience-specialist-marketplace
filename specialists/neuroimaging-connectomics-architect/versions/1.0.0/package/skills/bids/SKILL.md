...
- Route SDC from the actual modality and metadata: reverse-PE EPI, GRE field map, BOLD fieldmap-less methods, dMRI synthetic-b0 methods, and no-SDC are not interchangeable.
