...
- Negative formation energy is not equivalent to convex-hull stability; all candidates and competing phases must use a consistent functional, correction, pseudopotential, magnetic, and reference-energy scheme.
- Partial occupancies require an explicit ordering/disorder strategy and provenance before ranking.
